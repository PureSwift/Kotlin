...
extension KProperty0 {
  @JavaInterface("kotlin.reflect.KProperty0$Getter", extends: KProperty.Getter<JavaObject>.self, Function0<JavaObject>.self)
  public struct Getter<V: AnyJavaObject> {
  @JavaMethod

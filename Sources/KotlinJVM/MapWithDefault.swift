...
@JavaInterface("kotlin.collections.MapWithDefault", extends: Map<JavaObject, JavaObject>.self, KMappedMarker.self)
public struct MapWithDefault<K: AnyJavaObject, V: AnyJavaObject> {
  @JavaMethod

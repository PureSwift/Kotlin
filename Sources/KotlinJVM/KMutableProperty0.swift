...
@JavaInterface("kotlin.reflect.KMutableProperty0", extends: KProperty0<JavaObject>.self, KMutableProperty<JavaObject>.self)
public struct KMutableProperty0<V: AnyJavaObject> {
  @JavaMethod
  public func set(_ arg0: JavaObject?)

  @JavaMethod
  public func getSetter() -> KMutableProperty0.Setter<JavaObject>!
  ...
  @JavaMethod
  public func getGetter() -> KProperty0.Getter<JavaObject>!

...
extension KMutableProperty0 {
  @JavaInterface("kotlin.reflect.KMutableProperty0$Setter", extends: KMutableProperty.Setter<JavaObject>.self, Function1<JavaObject, Unit>.self)
  public struct Setter<V: AnyJavaObject> {
  @JavaMethod

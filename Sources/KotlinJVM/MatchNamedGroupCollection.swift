...
@JavaInterface("kotlin.text.MatchNamedGroupCollection", extends: MatchGroupCollection.self)
public struct MatchNamedGroupCollection {
  @JavaMethod
  public func get(_ arg0: String) -> MatchGroup!

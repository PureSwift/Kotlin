...
@JavaClass("kotlin.collections.MapWithDefaultImpl", implements: MapWithDefault<JavaObject, JavaObject>.self)
open class MapWithDefaultImpl<K: AnyJavaObject, V: AnyJavaObject>: JavaObject {
  @JavaMethod

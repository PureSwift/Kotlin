...
extension KMutableProperty2 {
  @JavaInterface("kotlin.reflect.KMutableProperty2$Setter", extends: KMutableProperty.Setter<JavaObject>.self, Function3<JavaObject, JavaObject, JavaObject, Unit>.self)
  public struct Setter<D: AnyJavaObject, E: AnyJavaObject, V: AnyJavaObject> {
  @JavaMethod

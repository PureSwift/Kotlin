...
extension KProperty2 {
  @JavaInterface("kotlin.reflect.KProperty2$Getter", extends: KProperty.Getter<JavaObject>.self, Function2<JavaObject, JavaObject, JavaObject>.self)
  public struct Getter<D: AnyJavaObject, E: AnyJavaObject, V: AnyJavaObject> {
  @JavaMethod
